...
?>
 ...
 <?=  $this->Form->input('RegistroSalida.fecha', array(
             'label'=> 'Fecha: ',
             'type'=> 'text',
             'value' => $this->request->data['RegistroSalida']['fecha'],
...
i18n: {
 ...
 <?php
        ...
        echo $this->Form->input('RegistroSalida.modoEntrega', array(
            ...
            'value' => $this->request->data['RegistroSalida']['modoEntrega'],
            'div'=>array('class'=>$clase),

        ));
        echo $this->Form->error('RegistroSalida.modoEntrega',null,array('class'=>'help-block','escape'=>false)); ?>

        <label for="Registro_salidaModoEntrega">Tipo de documento:</label>
        <?php
        echo $this->request->data['RegistroSalida']['clase_documento'];

        //CAMPO EMISOR

        if ($this->Form->isFieldError('RegistroSalida.usuarioEmisor'))
          $clase='form-group has-error';
        else {
          $clase='form-group';
        }
        ...
        <?php
               ...
               <?php
                ...
                if ($this->Form->isFieldError('RegistroSalida.contenido'))
                  $clase='form-group has-error';
                else {
                  $clase='form-group';
                }
                echo $this->Form->input('RegistroSalida.comentario', array(
                    'label'=> 'Descripción:',
                    'type'=> 'textarea',
                ...
                echo $this->Form->error('RegistroSalida.comentario',null,array('class'=>'help-block','escape'=>false)); ?>

        <label for="Registro_salidaModoEntrega">Usuario ejecutor:</label>
        <?php
        echo $options[$this->request->data['RegistroSalida']['usuarioEjecutor']];?>
