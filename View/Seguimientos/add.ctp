...
<div class="panel-heading"><h3>Añadir un seguimiento</h3></div>
<div class="panel-body">

<?php
	echo $this->Form->create('Seguimiento');
    echo $this->Form->input('Seguimiento.fecha', array(
														'class' => 'form-control',
														'label'=> 'Fecha',
														'type'=> 'text',
...
?>
<?php    
    echo $this->Form->input('usuario_responsable',array('class' => 'form-control'));
?>
