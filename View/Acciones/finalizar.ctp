...
<?php
	echo $this->Form->input('conclusiones',array('class' => 'form-control','label'=> 'Conclusiones'));
	echo $this->Form->input('usuario_cierre',array('class' => 'form-control','label'=> 'Responsable de cierre'));
...
<?php 
	echo $this->Form->submit(
								'Cerrar la Acción', array('div' => false, 'class' => 'btn btn-success')
							);
    echo $this->Form->end();
?>
