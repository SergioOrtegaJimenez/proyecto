...
<div class="panel-heading"><h3>Añadir un Evento</h3></div>
<div class="panel-body">
        
<?= $this->Form->create('Evento', array(
											'inputDefaults' => array(
																		'error' => false,
																		'div' => array(
																						'class' => 'form-group'
...
?>
<?=  $this->Form->input('Evento.fecha', array(
												'label'=> 'Fecha: ',
												'type'=> 'text',
												'value' => date("d/ m/ Y"),
...
<?php
	echo $this->Form->input('descripcion',array('class' => 'form-control','label'=>'Descripción del evento')); 
?>
