<div class="well well-lg"><h1>Búsqueda</h1></div>
<div class="row">
<div class="container-fluid">
<div class="row">
<div class="col-lg-2">

<?= $this->Form->create('RegistroSalida'); 
?>
...
<select id="lunch" name="option" class="selectpicker form-control" data-live-search="true" title="Seleccione una opción...">
    ...
    <option value="modoEntrega">Modo Entrega</option>
...
<?php foreach ($list as $regis):
		
?>


<tr class="<?= $regis['Plantilla']['color']; ?>" style="font-size:1em;">
<td><?= $regis['RegistroSalida']['fecha'];?></td>
...
<?php
    if (AuthComponent::user('id') == $regis['RegistroSalida']['usuarioEjecutor'] || AuthComponent::user('rol') == 'Administrador' || AuthComponent::user('rol') == 'Registrador' )
	{
        echo $this->Form->postLink(
									...
									array(	'action' => 'eliminarsalida', 
											$regis['RegistroSalida']['id']
										),
