...
<h3>Editar el Pedido</h3></div>
<div class="panel-body">

<?= $this->Form->create('Pedido', array(
										'inputDefaults' => array(
																	'error' => false,
																	'div' => array(
																					'class' => 'form-group'
...
<?php
	echo $this->Form->input('id_unidadgasto', array(
													'class' => 'form-control',
	...
	echo $this->Form->input('precioInicial',array('class' => 'form-control'));
	echo $this->Form->input('precioFinal',array('class' => 'form-control'));
...
<?php
	echo $this->Html->link(
							'Cancelar',array('action' => 'view',$id),array('class' => 'btn btn-danger')
						);
?>
...
<?php
	echo $this->Form->submit(
								'Modificar Pedido', array('div' => false, 'class' => 'btn btn-success')
							);
    echo $this->Form->end();
?>
