...
<?= $this->Form->create('Pedido', array(
    ...
    echo $this->Form->input('fecha_llegada', array(
													...
													'type'=> 'text',
													'placeholder' =>'Introduzca la fecha de llegada...',
													'id' => 'datepicker'
												)
							);
?>
...
<?php
	...
	echo $this->Form->input('conformidad', array(
													'class' => 'form-control',
													'type' => 'select',
...
<?php
  echo $this->Html->link(
							'Cancelar',array('action' => 'index'),array('class' => 'btn btn-danger')
						);
?>
...
<?php
	echo $this->Form->submit(
								'Finalizar Pedido', array('div' => false, 'class' => 'btn btn-success')
							);
    echo $this->Form->end();
?>
