<div class="well well-lg"><h1>Listado de eventos y cursos</h1></div>
<br><br>
<div class="row">
<div class="col-lg-2">
    
<?= $this->Form->create('Material');?>
<?= $this->Html->css(array('pikaday'));?>
            
<select id="lunch" name="option" class="selectpicker form-control" data-live-search="true" title="Seleccione una opción...">
    <option value="nombre">Denominación</option>
    <option value="descripcion">Descripción</option>
    <!--<option value="fecha">Fecha</option>-->
    <option value="duracion">Duración</option>
</select>
<br>
<select id="lunch2" name="option2" class="selectpicker form-control" data-live-search="true" title="Seleccione la fecha..." style="-webkit-appearance: none;">
...
<br>
<input type="text" class="form-control" name="keyword2" id="datepicker4" placeholder="Selecciona la fecha">
...
<?= $this->Html->Link(
						'<i class="fa fa-plus-circle"> Añadir evento/curso</i>',
						array(
...
<?php
	$ruta = $this->base . '/docadicionales/editar/' . $evento['Docadicional']['id'].'/eventos';
    if ($a%2==0)
        $tabla='info';
    else 
	{
...
<td onclick="window.document.location='<?= $ruta ?>';">

<?php
    $date = date_create($evento['Docadicional']['fecha']);
    echo date_format($date, 'Y-m-d');
?>
           
</td>
<td style="text-align:center" onclick="window.document.location='<?= $ruta ?>';"><?= $evento['Docadicional']['duracion']; ?></td>
...
<?= $this->Html->link(
						...
						array(
								'class' => 'btn btn-primary', 'style'=>'width:120px;' ,'escape'=>false,
							)
					)
?>
<br><br>
<?= $this->Form->postLink(
							...
							array('controller' => 'docadicionales','style'=>'width:120px;' , 'action' => 'eliminar', $evento['Docadicional']['id'],'eventos'
								),
