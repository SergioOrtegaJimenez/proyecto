...
<div class="panel-heading"><h3>Editar la acción con ID: <?= $accion['Accion']['id']; ?> </h3></div>
<div class="panel-body">

<?php
	echo $this->Form->create('Accion');
 ?>
...
<?php
    echo $this->Form->input('detalle_accion', array('class' => 'form-control','label' => 'Detalle de la acción'));
    echo $this->Form->input('plazo_implantacion', array('class' => 'form-control','label' => 'Plazo de Implantación'));
?>
...
<?php
    echo $this->Form->input('usuario_responsable', array('class' => 'form-control','label' => 'Usuario Responsable'));
    echo $this->Form->input('plazo_cierre', array('class' => 'form-control','label' => 'Plazo de Cierre'));
