...
<div class="panel-heading"><h3>Crear un Pedido</h3></div>
<div class="panel-body">

<?php
	echo $this->Form->create('Pedido');
    echo $this->Form->input('Pedido.fecha_solicitud', array(
															'class' => 'form-control',
															'label'=> 'Fecha de solicitud',
															'type'=> 'text',
															'placeholder' =>'Introduzca la fecha de solicitud del pedido...',
															'id' => 'datepicker'
															)
							);
	echo $this->Form->input('Pedido.fecha_llegada', array(
															'class' => 'form-control',
															'label'=> 'Fecha de llegada',
															'type'=> 'text',
															'placeholder' =>'Introduzca la fecha de llegada del pedido...',
															'id' => 'datepicker2'
														)
							);
?>
...
<?= $this->Form->input('id_unidadgasto', array(
												'class' => 'form-control',
												'label' => 'Unidad de Gasto',
												'type'    => 'select',
												'options' => $listadoug,
												'empty'   => false
											)
    ...
    echo $this->Form->input('tipo_gasto', array(
												'class' => 'form-control',
												'type' => 'select',
												'options' => array('En firme' => 'En firme','A justificar' => 'A justificar'),
												'default' => 'A justificar'
											)
							);
    echo $this->Form->input('precioInicial', array(
													'class' => 'form-control',
													'label' => 'Precio Inicial'
												)
							);
	echo $this->Form->input('precioFinal', array(
													'class' => 'form-control',
													'label' => 'Precio Final'
												)
							);
	echo $this->Form->input('observaciones', array('class' => 'form-control'));
	echo $this->Form->input('usuario_solicitante', array('type' => 'hidden', 'value' => AuthComponent::user('id')));
	echo $this->Form->input('finalizado', array('type' => 'hidden', 'value' => 'N'));
?>
...
<?php
	echo $this->Html->link(
							'Cancelar', array('action' => 'iniciopedido'), array('class' => 'btn btn-danger')
						);
?>
...
<?php
	echo $this->Form->submit(
								'Añadir Materiales', array('class' => 'btn btn-success', 'div' => false)
							);
    echo $this->Form->end();
?>
