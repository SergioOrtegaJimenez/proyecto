<div class="well well-lg"><h1>Gestión de las No Conformidades</h1></div>
<div class="row">
<div class="container-fluid">
<div class="row">
<div class="col-lg-2">

<?= $this->Form->create('Registro_entrada'); 
?>
...
<select id="lunch" name="option" class="selectpicker form-control" data-live-search="true" title="Seleccione una opción...">
	<option value="id">Nº RNC</option>
	<option value="tipoNoconformidad">Tipo</option>
...
<select id="lunch2" name="option2" class="selectpicker form-control" data-live-search="true" title="Seleccione una opción..." style="-webkit-appearance: none;">
	<option value="fecha_apertura" selected="selected">Fecha de apertura</option>
</select>
</div>
<div class="col-lg-3">
<input type="text" class="form-control" name="keyword" placeholder="Escribe los criterios de búsqueda">
<br>
<input type="text" class="form-control" name="keyword2" id="datepicker" placeholder="Selecciona la fecha de apertura">
...
<?= $this->Html->link(
						'<i class="fa fa-plus-square" aria-hidden="true"> Añadir Registro de No Conformidad</i>',
						array(
								'action' => 'rncgeneral'
							 ),
						array(
...
<?php  
    ...
    if (is_null($rnc['RegistroNoConformidad']['finalizado']))
	{
		$fin = 'No';
    }
    else 
...
<tr class="<?= $tabla?>">
<td><?= $rnc['RegistroNoConformidad']['id']; ?></td>
<td><?= $rnc['RegistroNoConformidad']['tipoNoconformidad']; ?></td>
<td><?= $rnc['RegistroNoConformidad']['descripcion']; ?></td>
<td>
						
<?php
	$date = date_create($rnc['RegistroNoConformidad']['fecha_apertura']);
