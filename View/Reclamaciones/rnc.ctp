<?= $this->Html->css(array(
	...
	$check = 'checked';
	$check2 = false;
	if (isset($this->request->data['RegistroNoConformidad']['segregar']))
	{
		if($this->request->data['RegistroNoConformidad']['segregar'] == 'NO')
		{
			$check = false;
			$check2 = 'checked';
		}
...
<?php
    //CAMPO TIPO NO CONFORMIDAD
	if ($this->Form->isFieldError('RegistroNoConformidad.tipoNoconformidad'))
        $clase='form-group has-error';
    else 
	{
        $clase='form-group';
    }
    echo $this->Form->input('RegistroNoConformidad.tipoNoconformidad', array(
    ...
    //CAMPO DESCRIPCION
	if ($this->Form->isFieldError('RegistroNoConformidad.descripcion'))
        $clase='form-group has-error';
    else 
	{
        $clase='form-group';
    }
    echo $this->Form->input('RegistroNoConformidad.descripcion', array(
    ...
    echo $this->Form->error('RegistroNoConformidad.descripcion',null,array('class'=>'help-block','escape'=>false)); 
?>
<?=  $this->Form->input('RegistroNoConformidad.fecha_apertura', array(
...
<?php
    //CAMPO TRATAMIENTO
	if ($this->Form->isFieldError('RegistroNoConformidad.tratamiento'))
        $clase='form-group has-error';
    else 
	{
        $clase='form-group';
    }
    echo $this->Form->input('RegistroNoConformidad.tratamiento', array(
    ...
    echo $this->Form->error('RegistroNoConformidad.tratamiento',null,array('class'=>'help-block','escape'=>false));
	//CAMPO USUARIO RESPONSABLE
	if ($this->Form->isFieldError('RegistroNoConformidad.usuario_responsable'))
        $clase='form-group has-error';
    else 
	{
        $clase='form-group';
    }
    echo $this->Form->input('RegistroNoConformidad.usuario_responsable', array(
    ...
    echo $this->Form->error('RegistroNoConformidad.usuario_responsable',null,array('class'=>'help-block','escape'=>false));
    //CAMPO PLAZO PREVISTO
	echo $this->Form->input('RegistroNoConformidad.plazo_aplicacion', array(
																				'label'=> 'Plazo para su aplicación: ',
																				'type'=> 'text',
																				//'value' => $this->request->data['RegistroNoConformidad']['fecha_insercion'],
																				'placeholder' =>'Introduzca la fecha...',
																				'id' => 'datepicker2'
																		)
						);

    //CAMPO MEDIOS A EMPLEAR
	if ($this->Form->isFieldError('RegistroNoConformidad.medios'))
        $clase='form-group has-error';
    else 
	{
        $clase='form-group';
    }
    echo $this->Form->input('RegistroNoConformidad.medios', array(
																	'label'=> 'Medios a emplear:',
																	'type'=> 'textarea',
																	'placeholder' =>'Introduzca los medios a emplear...',
																	'div'=>array('class'=>$clase)
																)
						);
    echo $this->Form->error('RegistroNoConformidad.medios',null,array('class'=>'help-block','escape'=>false));
?>
          
<!-- CAMPO SEGREGAR -->
<label>¿Es necesario separar o segregar la zona afectada?</label>
<div class="radio">
<label for="RegistroNoConformidadSi"><input type="radio" <?= $check; ?> name="data[RegistroNoConformidad][segregar]" id="RegistroNoConformidadSI" value="SI">Si</label>
</div>
<div class="radio">
<label for="RegistroNoConformidadNo"><input type="radio" <?= $check2; ?> name="data[RegistroNoConformidad][segregar]" id="RegistroNoConformidadNO" value="NO">No</label>
</div>
</div>
</div>
</div>
...
<?php
	//CAMPO ANÁLISIS DE LAS CAUSAS
	if ($this->Form->isFieldError('RegistroNoConformidad.analisis_causa'))
        $clase='form-group has-error';
    else 
	{
        $clase='form-group';
    }
    echo $this->Form->input('RegistroNoConformidad.analisis_causa', array(
																			'label'=> 'Análisis de la causa:',
																			'type'=> 'textarea',
																			'placeholder' =>'Introduzca el análisis de las causas...',
																			'div'=>array('class'=>$clase)
																		)
						);
    echo $this->Form->error('RegistroNoConformidad.analisis_causa',null,array('class'=>'help-block','escape'=>false));
?>
...
<?= $this->Form->input('id', array('type' => 'hidden'));
	...
	{
		echo $this->Form->input('id_pedido', array('type' => 'hidden', 'value' => $this->request->params['pass'][0]));
		echo $this->Form->input('id_proveedor', array('type' => 'hidden', 'value' => $this->request->params['pass'][1]));
    }
    echo $this->Form->input('usuario_apertura', array('type' => 'hidden', 'value' => AuthComponent::user('id')));
?>
