  ...
  <div class="col-md-10 col-md-offset-1">
    <div class="panel panel-primary">
      <div class="panel-heading">
          <h3 class="panel-title">Nueva entrada: <?= $datosPlantilla['Plantilla']['clase_documento']?></h3>
      </div>
...
<td class="is-empty"></td>
 ...
 <?php
        ...
        echo $this->Form->input('RegistroEntrada.modoEntrega', array(
            ...
            'type'=> 'select',
            'required' => true,
            'options' => array('Administración electrónica' => 'Administración electrónica', 'Correo Interno' => 'Correo Interno', 'Correo Externo' => 'Correo Externo', 'Correo Externo Certificado' => 'Correo Externo Certificado', 'Email' => 'Email', 'Mensajería' => 'Mensajería','En Mano' =>'En Mano', 'Fax' => 'Fax'),
        ...
        //CAMPO REMITENTE
         ...
         if ($this->Form->isFieldError('RegistroEntrada.campo'.$i))
           $clase='form-group has-error';
         else {
           $clase='form-group';
         }
		...
		if ($datosPlantilla['Plantilla']['campo'.$i] == '. Descripción:')
         ...
         echo $this->Form->input('RegistroEntrada.campo'.$i, array(
